...
```
결론  
이번 리서치를 통해 AST의 실질적인 구성 방식, 언어별 차이, 트리 구조 구현 방식 등을 명확히 이해할 수 있었습니다. 특히 AST 구조를 "실제 코드"로 표현하면서 추상적 개념이 어떻게 코드와 연결되는지 실감할 수 있었습니다. 앞으로 더 복잡한 문장이나 함수 선언, 조건문 등을 포함한 AST 확장 설계로 발전해 나갈 계획입니다. 아직 모르는 게 많지만 계속해서 학습하여 활용할 수 있도록 노력하겠습니다. 
